package com.fykj.dcoreview.view.custom;
...
public class MyView extends View {
    ...
    //1.在代码中创建View的时候用View(Context)。
    //2.当从XML inflate view的时候重写View(Context, AttributeSet)。
     ...
     * 此方法伪代码如下，可以看出onTouch() 和 onTouchEvent()的区别
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                KLog.d(TAG, "MyView 的 ACTION_MOVE" + "  x:" +  event.getX() + "  y:" + event.getY());
                break;
